  ...
  return (
    <Layout>
      <Box
        ...
        mt={20}
      >
        <Title>Statista NewsLetter Email</Title>
        <Text mt={5} textIndent={15}></Text>
        <List mt={5}>
          <ListItem mb="10px">
            <Meta>LAUNCH PROJECT</Meta>
            <Link href="https://statista-lemon.vercel.app/" target="_blank">
              Statista.Email
            </Link>
          ...
          <ListItem mb="10px">
            ...
            <Link
              target="_blank"
              href="https://github.com/adeyemi149/Statista_Email"
            >
              statista.Github
            </Link>
          </ListItem>
        ...
        <Image
          src="/assests/images/StatistaFullPage.png"
          alt="Dribble"
          loading="eager"
          placeholder="blur"
          boxShadow="dark-lg"
